{smcl}
{hline}
{hi:help xtdcce2}{right: v. 133 - 24. August 2018}
{hline}
{title:Title}
...
{p 6 13}{cmd: predict} [type] {newvar} {ifin} [{cmd:, xb stdp}{cmdab:r:esiduals} {cmdab:coeff:icients} {cmd: se} {cmd:replace} ]{p_end}
...
{p 8}{stata xtdcce2133 d.y , lr((L(1/3).d.y) (L(0/3).dp) (L(0/3).d.gd) ) lr_options(ardl) cr(d.y dp d.gd) cr_lags(3) fullsample}{p_end}
...
{p 4 8}Ditzen, J. 2018. xtdcce2: Estimating Dynamic Common Correlated Effcts in Stata. The Stata Journal, forthcoming.
...
{p 4 8}This version: 1.33 - 22. August 2018{p_end}
