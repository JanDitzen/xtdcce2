...
*/
capture program drop xtdcce2133_p
program define xtdcce2133_p
	...
	*local options `*'
	...
	xtdcce2133_p_int `anything' `if' `in', `options'
end

capture program drop xtdcce2133_p_int
program define xtdcce2133_p_int
